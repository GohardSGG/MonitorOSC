namespace Loupedeck.MonitorOSCPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MonitorOSCPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MonitorOSCPlugin.Resources.Resource.txt`.
